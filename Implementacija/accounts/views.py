...
class LoginView(View):
    ...
    def post(self, request):
        ...
        if user is None:
            return render(request, 'accounts/login.html', {'message': 'Pogresno korisnicko ime ili sifra'})
        login(request, user)
...
class RegisterForm(forms.Form):
    ...
    password = forms.CharField(required=True, min_length=8, label='Lozinka', widget=forms.PasswordInput())
    passwordrepeat = forms.CharField(required=True, min_length=8, label='Potvrdi lozinku', widget=forms.PasswordInput())
...
class HomeView(View):
    ...
    def get(self, request):
        ...
        return render(request, 'accounts/home.html', {"user_profile": profile, "best_players": best_players})
...
class ProfileView(View):
    ...
    def get(self, request):
        ...
        return render(request, 'accounts/profile.html', {'profile': profile, 'title': title})
